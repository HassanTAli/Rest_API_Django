...
from .views import hello,movie_list,movie_created,movie_detail,movie_delete,movie_update

app_name = "pinterest-v1"

urlpatterns = [
    path('hello-api/<str:mykey>',hello,name='hello'),
    path('api/v1/movie',movie_list,name='movie-index'),
    path('api/v1/movie/create',movie_created,name='movie-create'),
